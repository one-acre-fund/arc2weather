...
extractWeatherData <- function(rawData, 
  ...
  datExport <- extract_velox_gps(veloxRaster = convert_to_velox(rawData), spdf = convertSpdf(gpsFile, lonCol, latCol))
...
```{r}
output <- extractWeatherData(arcWeatherRaw, combineGpsFiles, "Latitude", "Longitude")
```
